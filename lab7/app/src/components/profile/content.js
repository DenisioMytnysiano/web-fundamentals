...
class Content extends React.Component{
    constructor(){
        super()
        this.state = {
            second_element_colour: "white",
            third_element_colour: "white"
        }
    }
    handleSecondElementClick = (e) => {
        this.setState({second_element_colour: generateRandomColor()})
    }

    handleThirdElementClick = (e) => {
        this.setState({third_element_colour: generateRandomColor()})
    }
    ...
    render(){
        return (
            <div>
                <p 
                    onClick={this.handleSecondElementClick} 
                    style={{backgroundColor: this.state.second_element_colour}}
                >
                    Місця народження: 15 липня, 2002 року м. Київ
                </p>
                <p 
                    onClick={this.handleThirdElementClick}
                    style={{backgroundColor: this.state.third_element_colour}}
                >Освіта: <br />&ensp;Гімназія №117 ім. Лесі Українки <br />&ensp;НТУУ "КПІ" м.Київ</p>
                <p>Хобі:</p>
                <ul>
                    <li>Програмування</li>
                ...
                <p>Улюблені книги:</p>
                <ol>
                    <li>Тінь вітру. К.Сафон</li>
                    <li>45 Татуювань менеджера. М.Батирєв</li>
                    <li>Чистий код. Р.Мартін</li>
                </ol>
                <p>
                    Оболо́нська на́бережна — вулиця в Оболонському районі міста Києва, житловий масив Оболонь. Пролягає від вздовж затоки Оболонь р. Дніпро від урочища Наталка до Прирічної вулиці. Перші поселення на місці Оболоні були з незапам'ятних часів. Тут жили племена скотарів. Це довів ще відомий вітчизняний археолог Вікентій Хвойка. Там навіть був встановлений великий ідол покровителю домашньої худоби, богу Велесу.
                ...
                <Image path="https://f.kyivmaps.com/location/715/r4jyf.jpg"/>
            </div>
        )
    }
}
